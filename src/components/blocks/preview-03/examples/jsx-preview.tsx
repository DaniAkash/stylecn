  ...
  return (
    <div className="space-y-4">
      ...
      <JSXPreview
        ...
        jsx={streamedJsx}
        // The component defines its own onError (Error => void) but it
        // intersects with the HTML SyntheticEvent onError on the underlying
        // div — TS narrows to an impossible intersection. Escape via any.
